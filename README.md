...
How to run:
1. Download or bash -c "$(curl -fsSL https://raw.githubusercontent.com/zorrong/Proxmox-script/refs/heads/main/install_openclaw.sh)"

3. chmod +x install_openclaw.sh
4. Save and run: ./install_openclaw.sh
